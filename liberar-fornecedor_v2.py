...
class liberarForn():
                ...
                if linha_cliente_err != 1:
                    ...
                    if int(cliente) == int(linha_cliente):
                        ...
                        if cliente == linha_cliente:
                            ...
                            linha_cliente2 = site.locator('xpath=/html/body/table/tbody/tr[2]/td/table/tbody/tr/td[2]'
    ...
    def validar_se_da_pra_ver_loading(self):
        ...
        while True:
            ...
            if da_pra_ver == 'inherit;' and contador <= 10:
                time.sleep(0.2)
                da_pra_ver = site.locator(f'xpath={text_carregando}').get_attribute('style')
                da_pra_ver = da_pra_ver.split()[-1]
                contador += 1
            if da_pra_ver == 'none;':
                ...
                da_pra_ver = site.locator(f'xpath={text_carregando}').get_attribute('style')
                da_pra_ver1 = da_pra_ver.split()[3]
                if da_pra_ver1 == 'none;':
                    return False
                else:
