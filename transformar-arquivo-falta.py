    ...
    if len(sys.argv) != 4:
       converter.deu_ruim()
        ...
        try:
            ...
            converter.deu_ruim()
    # converter.json_para_arquivo_de_falta('Consulta_de_preço-1661778630280.txt', 'teste.txt') # TESTAR
    # converter.json_dto_para_arquivo_falta('Consulta_de_preço-1661778630280.txt', 'teste.txt') # TESTAR
    # converter.dump_para_arquivo_falta('Consulta_de_preço-1661778630280.txt', 'teste.txt') # TESTAR
