...
def consultar(arquivo):
    ...
    for cnpj in arquivo:
        ...
        graylog.goto(f'http://logs-dash.zitausch.com:9000/streams/5de90061913ecb0854c57900/search?rangetype=relative&fields=source%2Ccrawler'
                     f'%2Cmessage&width=1920&highlightMessage=&relative=172800&q={cnpj_consulta}')
        time.sleep(3)
        ...
        if not_found == False:
            ...
            for usuario in lista_usuarios:
                ...
                graylog.goto(f'http://logs-dash.zitausch.com:9000/streams/5de90061913ecb0854c57900/search?rangetype=relative&fields=source%2Ccrawler'
                             f'%2Cmessage&width=1920&highlightMessage=&relative=172800&q={usuario_consulta}')
                load = graylog.locator(
        ...
        if not_found == True:
            ...
            print(f"{cnpj} - não localizado nos logs")
            continue
